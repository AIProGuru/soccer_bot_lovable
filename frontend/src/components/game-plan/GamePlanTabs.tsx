  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange} className="space-y-4">
      <TabsList className="grid w-full grid-cols-2 bg-coaching-700">
        <TabsTrigger value="match-details" className="data-[state=active]:bg-coaching-600">Match Details</TabsTrigger>
        <TabsTrigger value="tactics" className="data-[state=active]:bg-coaching-600">Tactics</TabsTrigger>
      </TabsList>

      <TabsContent value="match-details" className="bg-coaching-800 p-4 rounded-md border border-coaching-700">
        <MatchDetailsForm 
          matchDetails={matchDetails}
      ...
      <TabsContent value="tactics" className="bg-coaching-800 p-4 rounded-md border border-coaching-700">
        <TacticsForm 
          tactics={tactics}
